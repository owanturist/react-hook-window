...
for (const layout of LIST_LAYOUTS) {
  describe(`Fixed size ${layout} list`, () => {
    ...
    it('handles scrolling correctly', () => {
      ...
      scrollContainer({ layout, scroll: 55 })
      ...
      scrollContainer({ layout, scroll: 151 })
      ...
      // scroll to the down
      scrollContainer({ layout, scroll: 490 })
    ...
    it('handles container resizing', () => {
      ...
      // scroll to the down
      scrollContainer({ layout, scroll: 790 })
      getItemByIndex(13).should('not.exist')
      getItemByIndex(14).should('not.be.visible')
    ...
    it('handles item resizing', () => {
      ...
      // scroll to the down
      scrollContainer({ layout, scroll: 90 })
    ...
    it('handles item count change', () => {
      ...
      // scroll to the down
      scrollContainer({ layout, scroll: 240 })
      ...
      checkContainerSize({
        layout,
        size: 510,
        scrollSize: 50000 // 50px * 1000
      })

      // scroll to the down
      scrollContainer({ layout, scroll: 49490 })
    ...
    it('handles overscan count change', () => {
      ...
      // scroll some items down
      scrollContainer({ layout, scroll: 201 })
